                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card card-primary">
                            ...
                            <!-- /.card-header -->
                            <!-- form start -->
                            <form action="{{ route('peran.store', $films[0]->id) }}" method="POST">
                            @csrf
                                <div class="card-body">
                                    <div class="form-group">
                                        <label for="film">Judul</label>
                                        <input type="text" name="film" id="film" class="form-control" placeholder="Enter judul Film" disabled value="{{$films[0]->judul}}">
                                    </div>
                                    <div class="form-group">
